 ...
 * @since 2015年11月20日
 */
public class BreadFactoryImpl implements IFoodFactory {
	private static final Logger logger = LoggerFactory.getLogger(BreadFactoryImpl.class);
	/* (non-Javadoc)
	 * @see net.fantesy84.factory.IFoodFactory#create()
	 */
	@Override
	public IFoodBuilder create() {
		logger.debug("面包工厂开动[面包]生产机...");
		return new BreadBuilderImpl();
	}
