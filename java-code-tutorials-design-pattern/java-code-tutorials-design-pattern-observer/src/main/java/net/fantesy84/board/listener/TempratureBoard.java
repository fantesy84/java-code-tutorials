 ...
 * @since 2015年12月23日
 */
public class TempratureBoard implements Listener {
	...
	public String getName() {
		return TempratureBoard.class.getSimpleName();
	}
	...
	@Override
	public void update() {
		System.out.println("Temprature will update");
	}
